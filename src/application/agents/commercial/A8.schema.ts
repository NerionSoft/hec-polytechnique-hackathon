...
export const A8_SCHEMA_VERSION = "v1";
...
const A8FindingSchema = SharedFindingSchema.extend({
...
export const A8OutputSchema = z.object({
  factual_position: z.object({
    ...
    stated_competitors: z.array(z.string()).default([]),
    stated_differentiators: z.array(z.string()).default([]),
    evidence: z.array(EvidenceSchema).max(8),
  }),
  doc_grounded_thesis_signals: z
    .array(
      z.object({
        signal: z.string(),
  ...
  open_commercial_questions: z
    .array(
      z.object({
        ...
        ideal_evidence_to_request: z.string().nullable().optional(),
        linked_redflag_external_id: z.string().nullable().optional(),
      }),
    )
    .default([]),
  commercial_findings: z.array(A8FindingSchema).default([]),
