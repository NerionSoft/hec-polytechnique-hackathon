  ...
  return (
    ...
    >
      <div className="mb-12 max-w-[640px]">
        <h2
          className={cn(
            "whitespace-pre-line font-serif font-light",
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        <span
          className={cn(
            "font-serif text-[14px] tracking-[0.18em]",
            "text-foreground/40",
          )}
        >
          {stage.id}
...
function Connector({
  ...
  return (
    <span
      aria-hidden="true"
      className={cn(
        "pointer-events-none absolute right-[-6px] top-1/2",
        "hidden size-3 -translate-y-1/2 rotate-45",
        "border-r border-t border-foreground/20",
        "lg:block",
      )}
    />
  );
