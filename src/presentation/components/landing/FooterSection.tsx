  ...
  return (
    <footer className="border-foreground/[0.08] border-t">
      <div className={cn("mx-auto flex w-full max-w-[1200px] flex-col gap-10", "px-6 py-16")}>
        <div
          className={cn(
            "border-foreground/[0.08] flex flex-col gap-6 border-b",
        ...
        >
          ...
          <div className={cn("flex items-center gap-3", "text-foreground/60 text-[12px]")}>
            <span>{footer.powered}</span>
            <span className={cn("text-foreground/80 font-serif text-[16px]")}>
              {footer.poweredBy}
            </span>
          </div>
        </div>
